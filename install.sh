...
# Inspired and partially copied from https://github.com/atomantic/dotfiles

# include helpers for colorized echo and require_brew, etC
...
bot "Installing vim-plug plugin manager"
...
if [[ $response =~ (y|yes|Y) ]];then
  bot "downloading fonts for powerlevel10k oh-my-zsh theme"
  curl -o './fonts/MesloLGS NF Regular.ttf' -L 'https://github.com/romkatv/powerlevel10k-media/raw/master/MesloLGS%20NF%20Regular.ttf'
  curl -o './fonts/MesloLGS NF Bold.ttf' -L 'https://github.com/romkatv/powerlevel10k-media/raw/master/MesloLGS%20NF%20Bold.ttf'
  curl -o './fonts/MesloLGS NF Italic.ttf' -L 'https://github.com/romkatv/powerlevel10k-media/raw/master/MesloLGS%20NF%20Italic.ttf'
  curl -o './fonts/MesloLGS NF Bold Italic.ttf' -L 'https://github.com/romkatv/powerlevel10k-media/raw/master/MesloLGS%20NF%20Bold%20Italic.ttf'
